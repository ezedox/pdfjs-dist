    ...
    pdfjsWebAppOptions = void 0;
{
  ...
  pdfjsWebAppOptions = __webpack_require__(11);
}
;
{
...
function getViewerConfiguration() {
  return {
    appContainer: document.getElementById('viewer-body') ? document.getElementById('viewer-body') : document.body,
...
var _app_options = __webpack_require__(11);
...
var _pdf_sidebar = __webpack_require__(29);
...
var PDFViewerApplication = {
  ...
  _initializeViewerComponents: function () {
    var _ref5 = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee5() {
      ...
      var appConfig, dispatchToDOM, eventBus, pdfRenderingQueue, pdfLinkService, downloadManager, container, viewer;
  ...
  _createClass(ProgressBar, [{
    ...
    value: function hide() {
      ...
      if (document.getElementById('viewer-body')) {
        document.getElementById('viewer-body').classList.remove('loadingInProgress');
      } else {
...
var _ezedoxConstants = __webpack_require__(12);

var _ezedoxConstants2 = _interopRequireDefault(_ezedoxConstants);
...
var defaultOptions = {
  ...
  defaultUrl: {
    value: _ezedoxConstants2.default.defaultUrl,
    kind: OptionKind.VIEWER
  },
  defaultZoomValue: {
    value: _ezedoxConstants2.default.defaultZoomValue,
    kind: OptionKind.VIEWER
  },
  disableHistory: {
    value: false,
  ...
  showPreviousViewOnLoad: {
    value: _ezedoxConstants2.default.showPreviousViewOnLoad,
    kind: OptionKind.VIEWER
  },
  sidebarViewOnLoad: {
    value: 0,
  ...
  cMapUrl: {
    value: _ezedoxConstants2.default.cMapUrl,
    kind: OptionKind.API
  },
  disableAutoFetch: {
    value: false,
  ...
  workerSrc: {
    value: _ezedoxConstants2.default.workerSrc,
    kind: OptionKind.WORKER
  }
};
{
...
var CDN_VERSION = '0.0.4';
var CDN_BASE_URL = '//cdn.jsdelivr.net/npm/ezedox_pdfjs@' + CDN_VERSION;
var EZEDOX_CONSTANTS = {
...
exports.default = EZEDOX_CONSTANTS;
...
var _pdf_page_view_ezedox = __webpack_require__(27);
  ...
  _createClass(PDFPageView, [{
    ...
    value: function draw() {
      ...
      if (this.textLayerMode !== _ui_utils.TextLayerMode.DISABLE && this.textLayerFactory) {
        ...
        var _div$style = div.style,
            width = _div$style.width,
            height = _div$style.height;

        var esignCursorWrapper = new _pdf_page_view_ezedox.EsignPlaceholderContainer(width, height, this.id, textLayerDiv).showSignaturePlaceholders();
...
var getPartyEmailId = function getPartyEmailId(partyId) {
  var emailId = '';
  try {
    emailId = document.getElementById(partyId).querySelector('.share-email-input').value;
  } catch (error) {}
  return emailId;
};

var EsignPlaceholderContainer = function () {
  function EsignPlaceholderContainer(width, height, pageNo, textLayerDiv) {
    _classCallCheck(this, EsignPlaceholderContainer);
  ...
  _createClass(EsignPlaceholderContainer, [{
    key: 'showAssignedSignaturePlaceholders',
    value: function showAssignedSignaturePlaceholders(currentDocument, container) {
      var _this = this;

      currentDocument.coordinates.forEach(function (coordinate) {
        if (coordinate.page === _this.pageNo) {
          var values = {
            pageNo: coordinate.page,
            left: coordinate.left,
            top: coordinate.top,
            pageWidth: _this.width,
            pageHeight: _this.height
          };
          var placeholderDiv = window.createSignaturePlaceholders(values);
          container.appendChild(placeholderDiv);
        }
      });
    }
  }, {
    key: 'showUnsavedSignaturePlaceholders',
    value: function showUnsavedSignaturePlaceholders(currentDocument, container) {
      var currentPageNo = this.pageNo;
      ...
      currentPagePlaceholders.forEach(function (placeholder) {
        ...
        var partyEmailId = getPartyEmailId(placeholder.partyId);
        placeholderDiv.innerHTML = '<span class=\'contract-esign-placeholder-text\'>' + partyEmailId + '</span>';
        container.appendChild(placeholderDiv);
        window.makePlaceholderDraggable(window.jQuery(placeholderDiv), placeholder, width, height, currentPageNo);
      });
    }
  }, {
    key: 'showSignaturePlaceholders',
    value: function showSignaturePlaceholders() {
      var esignCursorWrapper = document.createElement('div');
      ...
      var esignCursoritem = document.createElement('div');
      ...
      try {
        ...
        if (previewModal) {
          var docId = previewModal.getAttribute('data-preview');
          var currentDocument = window.documentManager.getInstance().documents.get(docId);
          if (currentDocument) {
            ...
            if (isSigningAllowed) {
              if (Array.isArray(currentDocument.coordinates)) {
                this.showAssignedSignaturePlaceholders(currentDocument, esignCursorWrapper);
                if (currentDocument.coordinates.length) {
                  this.textLayerDiv.classList.add('show-placeholder');
                }
              } else {
                if (previewModal.classList.contains('contract-signing-active') && currentDocument._contractPlaceholders) {
                  this.showUnsavedSignaturePlaceholders(currentDocument, esignCursorWrapper);
                }
              }
            }
          }
  ...
  return EsignPlaceholderContainer;
}();

exports.EsignPlaceholderContainer = EsignPlaceholderContainer;
